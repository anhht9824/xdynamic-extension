        ...
        <div className="bg-gradient-to-r from-blue-500 to-blue-700 px-4 sm:px-6 py-6 sm:py-8">
          <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-3 w-full sm:w-auto">
              <button
                onClick={onEditProfile}
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-lg bg-blue-600 px-6 py-3 text-sm sm:text-base font-semibold text-white shadow-md transition-colors hover:bg-blue-700"
              >
              ...
              <button
                ...
                className="inline-flex h-10 w-10 items-center justify-center rounded-lg border border-blue-400 text-blue-600 transition-colors hover:bg-blue-50 sm:h-11 sm:w-11"
                title="Đăng xuất"
              >
