        ...
        <div className="space-y-6">
          <div className={`flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between p-4 ${softSurface} hover:bg-slate-50/95 dark:hover:bg-slate-900/70 transition-colors`}>
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Chặn nội dung độc hại ngay lập tức</p>
          ...
          <div className={`flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between p-4 ${softSurface} hover:bg-slate-50/95 dark:hover:bg-slate-900/70 transition-colors`}>
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Cập nhật danh sách đen mỗi ngày</p>
              {settings.autoUpdate && (
                <div className="text-xs text-gray-600 dark:text-gray-300">Lần cập nhật cuối: Hôm nay, 08:30</div>
              )}
            </div>
            <SettingToggle
        ...
        <div className="flex items-start">
          ...
          <div className="ml-3">
            ...
            <p className="text-sm text-blue-800 dark:text-blue-400">
              Việc tắt bảo vệ thời gian thực có thể khiến thiết bị của bạn dễ bị tấn công. Khuyến nghị giữ các tính năng
              ở trạng thái BẬT để có trải nghiệm an toàn nhất.
            </p>
          </div>
        </div>
      </div>
