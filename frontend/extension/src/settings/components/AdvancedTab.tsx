...
import { LogLevel, ActivityLog } from "../../types/common";
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-8" role="tabpanel" id="tabpanel-advanced" aria-labelledby="tab-advanced">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-6">
        ...
        {/* VPN Toggle */}
        <div className="flex items-center justify-between p-4 bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-900 dark:to-blue-900 rounded-lg mb-4">
          <div className="flex-1">
            <div className="flex items-center mb-1">
              ...
              <span className="ml-2 px-2 py-0.5 bg-purple-500 text-white text-xs rounded-full font-semibold">PRO</span>
            </div>
